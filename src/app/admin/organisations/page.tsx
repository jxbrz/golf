      ...
      <AppShell tournament={active}>
        <main className="space-y-4">
          ...
          <section className="rounded-lg border border-border bg-surface p-4 scorecard-shadow">
            <p className="sport-label">Platform admin</p>
            <h1 className="mt-1 text-3xl font-black">Organisations</h1>
            <p className="mt-1 text-muted">Manage clubs, societies and group leagues.</p>
          </section>
